...
> 2026-06-12 조사. 기술리포트([m4-tech-report-outline.md](../m4-tech-report-outline.md)) §6 "외부 벤치 비교"의 근거 문서. 한국/법률·세무·회계·일반 전문 LLM 벤치마크를 실측 조사해 K-TaxBench의 차별점을 표로 확정한다. 모든 항목은 논문/리포지터리 출처 + 접근일(2026-06-12)을 동반한다(추정 비교 금지 — [CLAUDE.md](../../CLAUDE.md) Judge 규약).
